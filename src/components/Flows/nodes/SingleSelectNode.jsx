...
import { Circle, Plus, Pencil, Trash2 } from 'lucide-react';

const SingleSelectNode = ({ data, selected }) => {
    ...
    <div className={`px-4 py-3 rounded-lg bg-node-message border ${selected ? 'border-blue-400' : 'border-blue-200'} min-w-[220px] max-w-[300px]`}>
      ...
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center">
          <Circle className="mr-2 text-blue-500" size={16} />
          <div className="text-sm font-medium text-blue-800">Single Select</div>
        </div>
      ...
      {editing ? (
        <div className="space-y-2 mb-2">
          <textarea
            ...
            rows={3}
            placeholder="Enter message (e.g., Select a payment method:)"
            value={message}
...
export default memo(SingleSelectNode);