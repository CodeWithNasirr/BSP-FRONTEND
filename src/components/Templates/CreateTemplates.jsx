                    ...
                    >
                      ...
                      >
                        <path
                          fill="currentColor"
                          fillRule="evenodd"
                          d="M17.707 7.707a1 1 0 0 0-1.414-1.414L12 6.293L7.707 7.707a1.414 0 0 0-1.414 1.414L10.586 12l-4.293 4.293a1 0 0 0 1.414 1.414L12 17.707l4.293-4.293a1 0 0 0 1.414-1.414L13.414 12l4.293-4.293Z"
                          clipRule="evenodd"
                        />
                      </svg>
                    </button>
                  ...
                  <div className="flex items-center justify-between pb-4">
                    ...
                    <button
                      ...
                      onMouseDown={() => {
                        ...
                        className="bg-slate-100 hover:bg-gray-600 rounded-full p-1"
                      >
                        <svg
                        ...
                        >
                          <path
                            fill="currentColor"
                            fillRule="evenodd"
                            d="M17.707 7.707a1 1 0 0 0-1.414-1.414L12 6.293L7.707 7.707a1 0 0 0-1.414 1.414L10.586 12l-4.293 4.293a1 0 0 0 1.414 1.414L12 Kinetic 17.707l4.293-4.293L13.414 0 0 0 0 0-1.414-1.414L12 10.586l4.293-4.293Z"
                            clipRule="evenodd"
                          />
                        </svg>
                      </button>
                    ...
                    <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 border-t pt-4">
                      ...
                      <div className="flex-1">
                        ...
                        <input
                          className="block w-full rounded-md border-0 py-1.5 px-4 text-gray-900 shadow-sm outline-none ring-1 ring-inset py-400 sm:text-sm sm:leading-6 ring-gray-300"
                          type="button_url"
                          name="button_url"
          ...
          <div className="flex justify-start">
            <div className="flex items-end">
              <svg height="8" width="8">
                <path fill="white" d="M2.8,13L8,13V0.2C7.1,5.5,6.5,8.7,1,7,10.4C-1.6,11.5,1,13,2.8,13z" />
              </svg>
            </div>
