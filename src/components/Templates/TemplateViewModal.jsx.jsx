...
const TemplateViewModal = ({ isOpen, onClose, template }) => {
 ...
 return (
  <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center px-2 sm:px-0">
    <div
      className="w-full sm:w-[90%] md:w-[70%] lg:w-[50%] xl:w-[35%] max-h-[80vh] overflow-auto border rounded-xl shadow-md p-4 sm:p-6 bg-cover bg-center relative bg-white"
      style={{
      ...
      <div className="flex justify-start">
        ...
        <div className="rounded-r-lg rounded-tl-lg bg-white py-2 px-3 w-full">
          {template.header_text && (
            <h1 className="font-semibold text-base sm:text-lg">{template.header_text}</h1>
          )}
