  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Left Panel */}
        <div
          className={`absolute flex flex-col items-center justify-center px-10 text-center top-0 h-full w-1/2 transition-transform duration-600 ease-in-out text-white
            ${isRightPanelActive ? "translate-x-0" : "-translate-x-1/5"}`}
        >
          <h1 className="font-bold leading-tight mb-5 shadow-text text-3xl sm:text-5xl">
            Hello <br /> friends
          </h1>
          <p className="font-medium mb-8 shadow-text text-xs sm:text-sm">
        ...
        {/* Right Panel */}
        <div
          className={`absolute flex flex-col items-center justify-center px-10 text-center top-0 right-0 h-full w-1/2 transition-transform duration-600 ease-in-out text-white
