  ...
  return (
    <div className="max-w-5xl mx-auto p-8 text-gray-800 bg-gray-50">
      ...
      <p className="mb-6 text-lg leading-relaxed">
        GPTX WhatsApp Marketing is a digital SaaS platform for WhatsApp automation, verified by Razorpay. As our services are delivered digitally, no physical shipping is involved. Below is our policy for service delivery.
      </p>

      <h2 className="text-2xl font-semibold text-blue-600 mt-10 mb-4">Service Delivery</h2>
      <ul className="list-disc list-inside mb-6 space-y-2">
        <li><strong>Access</strong>: After successful subscription and payment verification via Razorpay, you gain immediate access to the GPTX platform.</li>
        ...
        <li><strong>Support</strong>: For setup assistance, contact us at <a href="mailto:skofficial665@gmail.com" className="text-blue-600 underline hover:text-blue-800">skofficial665@gmail.com</a>.</li>
      </ul>
