        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mt-2 max-w-xs mx-auto">Trust Numlockitsolutions to grow their customer engagement</p>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center">
      ...
      {/* <section id="integrations" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 mt-4 max-w-2xl mx-auto">Connect Numlockitsolutions with your favorite tools and services</p>
          </div>
              ...
              <div className="flex flex-col lg:flex-row items-center py-8 px-6 lg:px-12">
                ...
                <div className="lg:w-1/2 lg:px-12 space-y-6">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed">
                    With Numlockitsolutions Connect CRM, you can enable a multi-agent chat system for seamless sales and support. Multiple agents can respond to incoming messages with access control and performance monitoring.
                  </p>
