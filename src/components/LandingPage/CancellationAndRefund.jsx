  ...
  return (
    <div className="max-w-5xl mx-auto p-8 text-gray-800 bg-gray-50">
      ...
      <p className="mb-6 text-lg leading-relaxed">
        At Numlockitsolutions WhatsApp Marketing, we aim to provide a seamless experience with our WhatsApp automation platform, verified by Razorpay. Below is our policy for cancellations and refunds.
      </p>

      <h2 className="text-2xl font-semibold text-blue-600 mt-10 mb-4">Cancellation Policy</h2>
      <ul className="list-disc list-inside mb-6 space-y-2">
        <li>You may cancel your subscription at any time via your account dashboard or by emailing <a href="mailto:support@numlockitsolutions.co.in" className="text-blue-600 underline hover:text-blue-800">support@numlockitsolutions.co.in</a>.</li>
      ...
      <ul className="list-disc list-inside mb-6 space-y-2">
        <li>Refunds are evaluated on a case-by-case basis. If you are unsatisfied within 7 days of subscribing, contact us at <a href="mailto:support@numlockitsolutions.co.in" className="text-blue-600 underline hover:text-blue-800">support@numlockitsolutions.co.in</a> for a potential refund.</li>
