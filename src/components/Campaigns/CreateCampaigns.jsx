...
function CreateTemplate() {
  ...
  const [mediaFile, setMediaFile] = useState(null); // State for uploaded media
  ...
  const handleChange = (e) => {
    ...
    setFormData((prevData) => {
      ...
      // Find the selected template to check header_type
          ...
          {isConnected && (
            <div className="md:w-[50%] md:p-8 overflow-y-auto">
              <div className="grid gap-x-6 gap-y-4 sm:grid-cols-6 mb-8 capitalize">
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="relative">
                    <select
                      ...
                      id="template_name"
                    >
                      <option value="" className="sm:text-sm" disabled>
                        Select a template
                      </option>
                ...
                <div className="sm:col-span-3">
                  <label htmlFor="Contacts" className="block text-sm leading-6 text-gray-900">
                    Contacts
                  </label>
                  <div className="relative">
                    <select
